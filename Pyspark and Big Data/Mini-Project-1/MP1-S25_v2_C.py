...
# - Fill in your Name (5 points) : Logan Camacho
...
Scanners_df = ss.read.csv("/storage/home/ljc5809/work/MiniProj1/Day_2020_profile.csv", schema = scanner_schema,                           header=True, inferSchema=False)
...
sorted_port_count = "/storage/home/ljc5809/work/MiniProj1/sorted_port_count_cluster.txt"
...
freq_count_port_RDD.saveAsTextFile("/storage/home/ljc5809/work/MiniProj1/freq_1_port_count_cluster.txt")
...
# The estimtated percentage of scanners that scan more than 1 port is : 32.44% of scanners that scan more than 1 port

# # We will use `MPscanner_port_list_RDD` in the remaining code for finding frequent 2-port sets and frequent 3 port sets.
...
output_path_2_port = "/storage/home/ljc5809/work/MiniProj1/2PS_ljc5809_cluster.csv"
...
DF2port = ss.read.csv("/storage/home/ljc5809/work/MiniProj1/2PS_ljc5809_cluster.csv", header=True, inferSchema=True)
...
# These output file names need to be changed in the cluster mode, so that you can compare them with those from the local mode.
output_path_3_port = "/storage/home/ljc5809/work/MiniProj1/3PS_ljc5809_cluster.csv"
